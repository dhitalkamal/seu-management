...
class OrgNotFoundError(DomainError):
    """No organization matches the given identifier."""
...
class OrgSlugTakenError(DomainError):
    """The requested slug is already in use by another organization."""
...
class InviteAlreadyExistsError(DomainError):
    """A pending invite already exists for this email at this organization."""
